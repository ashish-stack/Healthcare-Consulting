...
function RescheduleAndDelete(){
    ...
    const handleSubmit = (e) => {
        ...
        if(doaError===''){
            let newBooking = {date:dateOfAppointment, slot:slot}
            axios.patch('http://localhost:4000/bookings/:bookingid', newBooking, {headers:{"Content-Type":"application/json"}}).then((res) => {
                setSecond(true);
            })
        }
        ...
        function SubmitButton(){
            if(dateOfAppointment && slot){
                ...
                return <button onClick={handleSubmit} type="button" className="btn btn-success" style={{width:'90%', marginTop:'20px', marginBottom:'30px'}} disabled>Confirm Your Application</button>
            }
        }
            ...
            <React.Fragment>
                {second ?
                    <div className="booking">
                        <div style={{padding:'50px', paddingBottom:'20px'}}><img src="images/Notepad_icon.svg.png" alt="Notepad" style={{height:'50px', width:'45px', marginRight:'15px'}}></img><p style={{display:'inline', fontSize:'30px', fontWeight:'lighter'}}>Reschedule your Appointment</p></div>
                            <form>
                                ...
                                <div className="form-group">
                                    ...
                                    <div className="form-check-inline" value={slot}
                                    ...
                                    onChange={(event) => setSlot(event.target.value)}>
                                        <label className="form-check-label" htmlFor="slot">
                                        <input type="radio" className="form-check-input" id="slot" name="slot" value="11 AM to 12 AM" /> 11 AM to 12 PM
                                        </label>
                                    </div>
                    ...
                    <div style={{backgroundColor:'black', color:'white', width:'40%', marginLeft:'30%', borderRadius:'10px', textAlign:'center', marginTop:'15%', marginBottom:'15%'}}>
                        <h4 style={{paddingTop:'20px', marginBottom:'30px', fontWeight:'lighter'}}>Your appointment is rescheduled Successfully</h4>
...
export default RescheduleAndDelete;